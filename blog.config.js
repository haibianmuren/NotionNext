...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '1234🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: 'haibianmuren', // 您的昵称 例如 tangly1024
  BIO: 'haibianmuren的个人博客', // 作者简介
  ...
  // 樱花飘落特效
  SAKURA: process.env.NEXT_PUBLIC_SAKURA || turee, // 开关
  // 漂浮线段特效
